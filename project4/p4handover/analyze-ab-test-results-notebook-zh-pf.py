...
control_rate = df2[(df2['group']=='treatment')&(df2['converted']==1)].shape[0]/df2[(df2['group']=='control')].shape[0]
round(control_rate,4)                                           
...
# 
# 在control组的转化率是0.1204，在treatment组的转化率是0.1188。差异比较小，因此无法表明一个页面可以带来更多转化。
